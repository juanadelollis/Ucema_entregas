...
Apellido1 = input("Escriba su apellido: ")
Apellido2 = input("Escriba su segundo apellido: ")
print(Nombre[0].upper(),Apellido1[0].upper(),Apellido2[0].upper())
"""
...
#Sueldo = float(input("Escribi tu sueldo: "))
#Venta1 = float(input("Valor venta 1: "))
#Venta2 = float(input("Valor venta 2: "))
#Venta3 = float(input("Valor venta 3: "))
#Venta4 = float(input("Valor venta 4: "))
#Comision = Venta1 * 0,1 + Venta2 * 0,1 + Venta3 * 0,1 + Venta4 * 0,1 
#print("La ganancia total es de: ",(Sueldo + Comision))

#Ejercicio 8
"""Punto1 = int(input("Respuesta: "))
if Punto1 == 1
  print("")
Punto2 = int(input("Respuesta: "))
Punto3 = int(input("Respuesta: "))
Punto4 = int(input("Respuesta: "))
Punto5 = int(input("Respuesta: "))"""
